...
Bianbu V1.0 基于Ubuntu 23.10构建，Ubuntu 社区已停止对23.10的维护与更新。进迭时空基于Ubuntu 24.04，针对RISC-V深度优化发布Bianbu V2.0，最新版本迭代至V2.0.4，现已决定对Bianbu V1.0停止维护（End of Life）。

| 版本  | 停止支持日期 | 延长生命周期（Extended Life-cycle Support, ELS）停止日期|
| ------------ | -------- | -------- |
|    Bianbu 1.x.x    |   2024/12/31     | NO |

建议用户更新Bianbu V2.x版本使用，更新方式可以参考：**用户指南-系统升级**。
