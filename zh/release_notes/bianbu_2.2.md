...
使用此源即可安装到后续的2.2.x（如2.2.1）发布的包，其存放在bianbu-v2.2-updates。
...
Bianbu Linux版本：[v2.2](https://bianbu-linux.spacemit.com/release_notes/bl-v2.2.y)
...
- bianbu-esos: 适配v2.2内核；新增相关许可证信息
